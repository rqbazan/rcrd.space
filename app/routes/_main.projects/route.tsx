...
export default function ProjectsPage() {
  return (
    <>
      ...
      />
      <CoverImg
        {...getImageProps("covers/projects-v2")}
        alt="Abstract art"
        width={2000}
        height={1500}
        className="mb-9"
        description={
          <p className="small muted">
            Photo by{" "}
            <Anchor href="https://unsplash.com/@fakurian">
              Milad Fakurian
            </Anchor>{" "}
            on{" "}
            <Anchor href="https://unsplash.com/s/photos/abstract">
              Unsplash
            </Anchor>
          </p>
        }
      ...
      <div className="flex flex-col space-y-8">
        ...
        <ProjectPost
          ...
          content={
            <React.Fragment>
              Takes a list of strings and sorts them by alphabetical order, but
              it uses a priority algorithm to sort the items that are more
              important to the user. The name was inspired by the project in{" "}
              <Anchor href="https://apps.apple.com/pe/app/pedidosya-delivery-app/id490099807">
                PedidosYa.
              </Anchor>
            </React.Fragment>
        ...
        <ProjectPost
          ...
          content={
            <React.Fragment>
              ...
              by{" "}
              <Anchor href="https://twitter.com/JoshWComeau">
                Josh Comeau
              </Anchor>
              , I&rsquo;ve created a reusable solution for the
              dark-mode-flick-problem. My own website use this solution.
            </React.Fragment>
          }
        />
        <ProjectPost
          ...
          content={
            <React.Fragment>
              ...
              in React. Get features by its slug identifier or get a binary
              output using flag queries.
            </React.Fragment>
          }
        />
        <ProjectPost
          ...
          content={
            <React.Fragment>
              ...
              <Anchor href="https://www.weeksofmylife.com">
                www.weeksofmylife.com
              </Anchor>
              . It&rsquo;s a calculator to see how many weeks of life you just
              consumed. Based on the average life expectancy for some country:
              USA, Italy and Peru.
            </React.Fragment>
          }
        />
        <ProjectPost
          ...
          content={
            <React.Fragment>
              I created my CV using{" "}
              <Anchor href="https://react-pdf.org/">ReactPDF</Anchor>, which is
              another renderer instead of ReactDOM. The information is saved in
              my personal Airtable and consumed in real-time using a Vercel
              Lambda Function.
            </React.Fragment>
          }
        />
        <ProjectPost
          ...
          links={[
            {
              href: "https://github.com/rqbazan/graphql-jobs#readme",
              icon: GitHubSvgIcon,
            },
            {
          ...
          content={
            <React.Fragment>
              Application made fully with TypeScript, using Storybook for
              component-driven development. Taking advance of client side Apollo
              resolvers. Powered by{" "}
              <Anchor href="https://api.graphql.jobs/">
                the free GraphQL Jobs API.
              </Anchor>
            </React.Fragment>
          }
        />
          ...
          content={
            <React.Fragment>
              ...
              <Anchor href="https://www.youtube.com/watch?v=1rP3nNY2hTo">
                Animation and 3D in react-three-fiber (with Paul Henschel) —
                Learn With Jason
              </Anchor>
              , I decided to try to create this project just for fun, using The
              Rubik&rsquo;s cube Doodle for inspiration.
            </React.Fragment>
          }
        />
        <ProjectPost
          ...
          links={[
            {
              href: "https://github.com/rqbazan/aimo-challenge#readme",
              icon: GitHubSvgIcon,
            },
            {
          ...
          content={
            <React.Fragment>
              ...
              , in order to get the Software Engineer Frontend position of the
              company.
            </React.Fragment>
          }
        />
        <ProjectPost
          ...
          links={[
            {
              href: "https://github.com/rqbazan/zeit-toast-clone#readme",
              icon: GitHubSvgIcon,
            },
            {
              href: "https://www.npmjs.com/package/zeit-toast-clone",
              icon: PackageSvgIcon,
            },
            {
          ...
          content={
            <React.Fragment>
              A front-end challenge required by myself, I worked with animation
              effects powered by the awesome spring library.{" "}
              <Anchor href="https://vercel.com/design/toast">
                Here the original.
              </Anchor>
            </React.Fragment>
          }
        ...
        <ProjectPost
          ...
          links={[
            {
              href: "https://github.com/rqbazan/rcrd.space#readme",
              icon: GitHubSvgIcon,
            },
            {
        ...
        <ProjectPost
          ...
          links={[
            {
              href: "https://github.com/rqbazan/hashing-with-pbkdf2#readme",
              icon: GitHubSvgIcon,
            },
            {
          ...
          content={
            <React.Fragment>
              Serverless application to use the pbkdf2 algorithm and a sort of
              playground to hash any text like account safe passwords.{" "}
